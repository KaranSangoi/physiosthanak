...
export const servicesExtended3: ServiceCategory[] = [
  {
    ...
    metaTitle: 'Child Physiotherapist in Borivali West | PhysioSthanak',
    heroDescription: 'Expert child physiotherapist in Borivali for developmental delays, cerebral palsy, and pediatric sports injuries by Dr. Shiva Jain Sangoi (PT).',
    ...
    conditions: [
      {
        ...
        externalLink: { url: 'https://en.wikipedia.org/wiki/Cerebral_palsy', text: 'cerebral palsy' },
      ...
      },
      {
        ...
        parentCategory: 'pediatric-physiotherapy',
        externalLink: { url: 'https://en.wikipedia.org/wiki/Developmental_disability', text: 'developmental disability' },
      ...
      },
      {
        ...
        parentCategory: 'pediatric-physiotherapy',
        externalLink: { url: 'https://en.wikipedia.org/wiki/Sports_injury', text: 'sports injuries' },
      ...
      },
      {
        ...
        parentCategory: 'pediatric-physiotherapy',
        externalLink: { url: 'https://en.wikipedia.org/wiki/Scoliosis', text: 'scoliosis' },
  ...
  },
  {
    ...
    metaDescription: 'Lady physiotherapist in Borivali. 5.0★ rated female physio. Prenatal, postnatal, pelvic floor & PCOS care by Dr. Shiva Jain Sangoi (PT). Book now.',
    h1: 'Lady Physiotherapist in Borivali — Women\'s Health & Pelvic Floor Care',
    metaTitle: 'Lady Physiotherapist in Borivali West | PhysioSthanak',
    heroDescription: 'Expert female physiotherapist in Borivali for women\'s health — prenatal, postnatal, pelvic floor therapy, and wellness by Dr. Shiva Jain Sangoi (PT).',
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: 'Yes. Dr. Shiva Jain Sangoi (PT) is a qualified lady physiotherapist with MPTh (Ortho) and FIFA Diploma credentials. She treats all women\'s health conditions including pelvic floor, prenatal, postnatal, and PCOS-related issues at the clinic and via home visits.',
      },
    ],
    conditions: [
      {
        ...
        externalLink: { url: 'https://en.wikipedia.org/wiki/Prenatal_care', text: 'prenatal care' },
      ...
      },
      {
        ...
        parentCategory: 'womens-health-physiotherapy',
        externalLink: { url: 'https://en.wikipedia.org/wiki/Postpartum_period', text: 'postpartum recovery' },
      ...
      },
      {
        ...
        metaDescription: 'Pelvic floor physiotherapist in Borivali — lady physio Dr. Shiva Jain Sangoi (PT). Expert care for incontinence & pelvic floor dysfunction.',
      ...
      },
      {
        ...
        parentCategory: 'womens-health-physiotherapy',
        externalLink: { url: 'https://en.wikipedia.org/wiki/Polycystic_ovary_syndrome', text: 'polycystic ovary syndrome' },
      ...
      },
      {
        ...
        parentCategory: 'womens-health-physiotherapy',
        externalLink: { url: 'https://en.wikipedia.org/wiki/Diastasis_recti', text: 'diastasis recti' },
  ...
  },
  {
    ...
    metaDescription: 'Hand & wrist physiotherapy in Borivali. 5.0★ rated. Carpal tunnel, trigger finger & post-surgery rehab. Dr. Shiva Jain Sangoi (PT), MPTh. Book today.',
    ...
    externalLink: { url: 'https://en.wikipedia.org/wiki/Hand_therapy', text: 'hand therapy' },
    benefits: [
      {
    ...
    conditions: [
      {
        ...
        externalLink: { url: 'https://en.wikipedia.org/wiki/Carpal_tunnel_syndrome', text: 'carpal tunnel syndrome' },
      ...
      },
      {
        ...
        parentCategory: 'hand-physiotherapy',
        externalLink: { url: 'https://en.wikipedia.org/wiki/Trigger_finger', text: 'trigger finger' },
      ...
      },
      {
        ...
        parentCategory: 'hand-physiotherapy',
        externalLink: { url: 'https://en.wikipedia.org/wiki/De_Quervain_syndrome', text: 'De Quervain syndrome' },
