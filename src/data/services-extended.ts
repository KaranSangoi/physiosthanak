...
export const servicesExtended: ServiceCategory[] = [
  {
    ...
    metaDescription: 'Post-surgery rehabilitation in Borivali. 5.0★ rated. Knee, hip, spine & ACL surgery recovery by Dr. Shiva Jain Sangoi (PT), MPTh Ortho. Book today.',
    ...
    conditions: [
      {
        ...
        metaDescription: 'Knee replacement rehab in Borivali. 5.0★ rated. Expert post-surgery recovery by Dr. Shiva Jain Sangoi (PT), MPTh Ortho. Home visits available. Book now.',
