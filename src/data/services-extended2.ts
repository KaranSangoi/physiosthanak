...
export const servicesExtended2: ServiceCategory[] = [
  {
    ...
    metaDescription: 'Neurological physiotherapy in Borivali. 5.0★ rated. Stroke, paralysis & nerve injury rehab by Dr. Shiva Jain (MPTh Ortho). Book consultation.',
  ...
  },
  {
    ...
    metaDescription: 'Orthopedic physiotherapy in Borivali. 5.0★ rated. Arthritis, joint pain & fracture rehab by Dr. Shiva Jain (MPTh Ortho). Book today.',
