...
export const siteConfig: SiteConfig = {
  ...
  doctorCredentials: 'BPTh, MPTh (Ortho), FIFA Diploma in Football Medicine, 9+ Years Experience, 8000+ Cases Treated',
  googleReviewUrl: 'https://g.page/r/CQu9kCmpO9u2EBM/review',
