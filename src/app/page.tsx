...
const trustIndicators = [
  ...
  },
  {
    ...
    title: "Cases Treated",
    description:
      "Successfully treated patients with diverse conditions and requirements.",
  },
  {
    icon: "home",
    number: "∞",
    ...
    description:
      "Convenient home-based physiotherapy for patients with mobility limitations.",
  },
];
  ...
  founder: {
    ...
    hasCredential: [
      ...
      },
      {
        ...
        name: "FIFA Diploma in Football Medicine",
      },
    ],
  },
  address: {
        ...
        <div className="container-max">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {trustIndicators.map((indicator, index) => (
              <div
                key={index}
                className="flex flex-col items-center p-6 rounded-lg hover:bg-bg-light transition-colors text-center"
              >
        ...
        <div className="container-max">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
            <div>
              ...
              <a
                href="/about"
                className="text-accent-pink hover:underline font-medium mb-8 inline-block"
              >
      ...
      <section className="section-padding bg-white">
        <div className="container-max">
          <div className="text-center mb-14">
            ...
            <p className="text-lg text-text-light max-w-2xl mx-auto">
              Professional physiotherapy services across Borivali and
              surrounding areas
            </p>
          </div>
